...
export default function DashboardPage() {
  ...
  const confirmBuy = useCallback(() => {
    ...
    if (userCoins >= frame.price) {
      ...
      showToast(
        `Ups! Koin kamu kurang untuk beli frame ${frame.name}.`,
        "error",
      );
      setShowBuyModal(false);
    }
      ...
      <div className="bg-[#FFD93D] border-4 border-black rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] p-4 md:p-6 mb-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-3 flex-wrap justify-center">
              ...
              {showHistory && (
                <div className="absolute top-[120%] left-[50%] -translate-x-1/2 w-48 bg-white border-4 border-black rounded-lg shadow-[4px_4px_0_rgba(0,0,0,1)] p-3 z-[100] animate-in fade-in zoom-in duration-200">
                  ...
                  <div className="relative z-10 text-center flex flex-col items-center">
                    <p className="text-[11px] md:text-sm font-semibold text-black">
                      Terakhir top up
                    </p>
                    <p className="text-[11px] md:text-sm font-black text-black mt-1">
                      12- Desember - 2025
                    </p>
                  </div>
                </div>
            ...
            <button className="bg-[#F4B266] border-4 border-black rounded-xl px-4 py-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all flex items-center gap-2 font-black text-black">
              <svg
                width="24"
                height="24"
                viewBox="0 0 60 60"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 pb-4 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
              {frames.map((frame) => (
                <div
                  ...
                  className={`bg-white border-4 border-black rounded-xl p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] cursor-pointer hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all flex flex-col items-center
                                        ${selectedFrame === frame.id ? "bg-[#F2EDD0]" : "bg-white"}`}
                >
        ...
        <div className="relative">
          ...
          <div className="bg-white border-4 border-black rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] p-6 z-0 relative flex flex-col items-center">
            <h2 className="text-xl md:text-2xl font-black text-black mb-4 w-full text-center">
              Frame pilihan kamu
            </h2>
            ...
            <button
              ...
              className={`w-full mt-auto bg-[#6BCF7F] border-4 border-black rounded-xl py-3 font-black text-lg text-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all uppercase`}
            >
              {isCurrentFrameLocked ? (
                "Beli Frame?"
              ) : (
                <Link href="/studio">Foto pake ini</Link>
              )}
            </button>
          </div>
        </div>
      ...
      {showBuyModal && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 px-4">
          <div className="bg-white border-[6px] border-black rounded-[2rem] p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] max-w-sm w-full text-center animate-in fade-in zoom-in duration-200">
            ...
            <p className="text-[#FFB800] text-3xl font-black mb-8 drop-shadow-[1px_1px_0_rgba(0,0,0,1)]">
              {currentFrame.price} Koin
            </p>
