                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-stretch">
                    ...
                    <div className="w-full lg:w-[320px] shrink-0 relative mt-8 lg:mt-0 lg:ml-4 z-20">
                        <div className="bg-[#F4D03F] w-full border-4 border-black rounded-3xl p-8 flex flex-col items-center justify-center drop-shadow-[12px_12px_0_rgba(0,0,0,1)] transform lg:rotate-3 hover:rotate-0 transition-transform duration-300 h-full">
                            ...
                            <div className="w-full flex-1 flex flex-col justify-end mt-auto gap-4">
                                <div className="bg-white border-[4px] border-black rounded-2xl py-3 px-6 font-black flex items-center justify-center gap-3 drop-shadow-[5px_5px_0_rgba(0,0,0,1)] z-30 cursor-default">
                                    ...
                                    <span className="text-xl">20 Coins</span>
                                </div>
                                <button className="w-full bg-[#0277BD] text-white font-black text-2xl py-4 border-4 border-black rounded-2xl drop-shadow-[5px_5px_0_rgba(0,0,0,1)] flex items-center justify-center gap-3 hover:bg-[#01579B] hover:translate-x-1 hover:translate-y-1 hover:drop-shadow-[2px_2px_0_rgba(0,0,0,1)] transition-all active:scale-95 uppercase tracking-widest">
