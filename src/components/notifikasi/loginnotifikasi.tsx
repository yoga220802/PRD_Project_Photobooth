...
export default function LoginNotification({ onClose }: LoginNotificationProps) {
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white border-4 md:border-[6px] border-black p-6 md:p-8 max-w-md w-full shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] md:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
                ...
                <h2 className="text-xl md:text-2xl font-black text-center mb-4 text-black">Berhasil Login!</h2>
